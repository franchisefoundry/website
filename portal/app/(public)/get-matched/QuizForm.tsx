    ...
    return (
      <>
        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(255,255,255,0.97)', backdropFilter: 'blur(8px)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', zIndex: 9999, fontFamily: "'Sora', system-ui, sans-serif" }}>
          ...
          <p style={{ margin: '0 0 10px', fontSize: '1.45rem', fontWeight: 600, color: '#3a4a3a', letterSpacing: '-0.01em', textAlign: 'center' }}>
          ...
          <div style={{ position: 'absolute', bottom: 0, left: 0, height: 4, background: 'linear-gradient(90deg, #3a4a3a, #c8924a)', borderRadius: '0 2px 2px 0', animation: 'ffProgress 6s ease-out forwards' }} />
        </div>
      </>
    )
  }
